    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <img src="image/Rahul_Ranjan.jpeg" width=100 height=100 alt="Rahul Ranjan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Rahul Ranjan & Arun Kumar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+916202945996</h4>
		<h4 style="font-family:'typo' ">rahulranjan.s1mca21@bvicam.in</h4>
		<h4 style="font-family:'typo' ">Bvicam delhi</h4></div></div>
		</p>
      </div>
