  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Rahul_Ranjan.jpg" width=100 alt="Rahul Ranjan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Rahul Ranjan  (6202945996)   & Arun Kumar (7654572182)</a>
		
		<h4 style="font-family:'typo' ">rahulranjan.s1mca21@bvicam.in</h4>
		
		<h4 style="font-family:'typo' ">Bharati Vidyapeeth's (Delhi)</h4></div></div>
		</p>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:black;font-family:'type' "><center>ADMIN LOGIN</center></span></h4>
      </div>
